...
select base FROM  fin.cxp_doc where documento = 'LB01094'
update  fin.cxp_doc set base = 'COL'  where documento = 'LB01094'
...
SELECT neg.*, 
            ...
            WHERE fecha_negocio <= '2018-06-01' -- AND estado_neg IN ('T')
...
-- insert into fin.cxp_doc select * from tem.lb01094_mcamila_DET WHERE DOCUMENTO = 'FZL00446'

UPDATE fin.cxp_doc SET  WHERE DOCUMENTO = 'FZL00446'

SELECT * FROM FIN.CXP_ITEMS_DOC WHERE  DOCUMENTO = 'FZL00446'

select * from administrativo.historico_deducciones_fianza where id = 7342

select * from con.comprobante where numdoc LIKE '%LP%'
union all
