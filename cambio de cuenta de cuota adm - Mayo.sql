--create table tem.cm_Mayo2018 as
...
--select * from tem.cm_Mayo2018
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--select * from tem.Mayo2018_1

--create table tem.Mayo2018_1 as
select * from con.comprodet 
--update con.comprodet set cuenta = '16252160'
where numdoc in (
...
and periodo = '201805' and valor_credito != 0 and tipodoc = 'CM' and cuenta != '16252160' 
