...
---------------------------------
--Query principal de paz y salvo
---------------------------------
...
--             AND cod_cli = '10776083' --cod_cli = '72277150'
--             AND fac.reg_status=''
...
--             --financia_aval = 't'
--             neg.negocio_rel =''
--             AND neg.cod_cli = '10776083' -- neg.cod_cli = '72277150'
--             GROUP BY
--             neg.cod_cli,
--             cliente,
--             neg.fecha_negocio,
...
-------------------------
--    Alter Table para desarrollo: Visto_bueno_poliza
-------------------------

-- 1. ALTER TABLE NEGOCIOS ADD COLUMN visto_bueno_poliza varchar(1) NOT NULL DEFAULT 'N'::character VARYING;
-- 2. ALTER TABLE NEGOCIOS ADD COLUMN usuario_visto_bueno_poliza varchar(10) NOT NULL DEFAULT ''::character varying;
...
-- pazySalvo.js
-- AdminFintraDAO.xml
-- GarantiasComunitariasAction.java
-- GarantiascomunitariasDAO.java
-- GarantiasComunitariasimpl.java
-- GarantiascomunitariasDAO.xml
-- reporte_garantias.js
