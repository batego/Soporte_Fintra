...
CREATE TABLE tem.MC16440_comp AS 
select * from con.comprobante 
--delete from con.comprobante 
where numdoc in (select documento from con.factura where negasoc = 'MC16440')

CREATE TABLE tem.MC16440_compdt AS 
...
CREATE TABLE tem.MC16440_ingfen AS 
select * from ing_fenalco where codneg = 'MC16440' 
-- delete from ing_fenalco where codneg = 'MC16440' 


-- 3- Egreso
CREATE TABLE tem.MC16440_egr_comp AS 				
select * from con.comprodet 
--delete from con.comprodet
where numdoc in  (select document_no from  egresodet where document_no = 'EG63278')

CREATE TABLE tem.MC16440_egr_comprob AS 			
select * from con.comprobante 
--delete from con.comprobante 
where numdoc in (select document_no from egreso where document_no = 'EG63278')

CREATE TABLE tem.MC16440_egrdt AS 			
select * from egresodet
--delete from egresodet
where document_no in ('EG63278')		
...
CREATE TABLE tem.cxp_MC16440 AS 
...
where documento_Relacionado in ('MC16440')

--se elimina la cxp a superefectivo
SELECT * FROM fin.cxp_doc WHERE documento_Relacionado in ('MC16440') AND documento = 'CXP000005631'; 
--delete FROM fin.cxp_doc WHERE documento_Relacionado in ('MC16440') AND documento = 'CXP000005631'; 
-- 6-
