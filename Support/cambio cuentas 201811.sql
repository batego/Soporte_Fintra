...
cuenta = 'I010140014205' and periodo ='201811' and reg_status != 'A'
...
cuenta = 'I010140014205' and periodo='201811' 
...
documento in ( select documento from con.factura where tipo_documento = 'FAC' and periodo = '201811')
...
documento in ( select documento from fin.cxp_doc where  periodo = '201811')
...
document_no in (SELECT document_no FROM egreso where periodo ='201811')
...
cuenta = 'I010130014205' and periodo ='201811' and reg_status != 'A'
...
cuenta = 'I010130014205' and periodo='201811'; 


select codigo_cuenta_contable,* from con.factura_detalle  where 
-- update con.factura_detalle set cuenta = '28150531', last_update=now(), user_update='BTERRAZA' WHERE
documento in ( select documento from con.factura where  periodo = '201811')
...
cuenta = 'I010300014205' and periodo ='201811' and reg_status != 'A';
...
cuenta = 'I010300014205' and periodo='201811'; 
