select
                ...
                and a.cod in ('CA500750103','CA500750104','CA500750105','CA500750106')
                and a.fecha_contabilizacion = '0099-01-01 00:00:00'
                and a.reg_status = ''
                and a.periodo=''
                order by a.tipodoc,a.fecha_doc,cuenta;
                
               select * from ing_fenalco where cod in ('CA500750103','CA500750104','CA500750105','CA500750106');;;
               select * from con.comprobante where numdoc in ('CA500750103','CA500750104','CA500750105','CA500750106');