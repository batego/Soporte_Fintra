SELECT 
                ...
                FROM (
                        ...
                        --AND anticipo.fecha_corrida::date &lt;= ?::date
                        ...
                        --AND reanticipo.fecha_corrida::date &lt;= ?::date
                ...
                SELECT cxc_corrida, * FROM etes.manifiesto_carga WHERE planilla IN ('0238342','0238343','0238346'); --R0036972