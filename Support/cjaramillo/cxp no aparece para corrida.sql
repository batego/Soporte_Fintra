...
* 
FROM fin.cxp_doc WHERE documento IN ('EDS0000376') ;
SELECT * FROM fin.cxp_ITEMS_doc WHERE documento = 'R191884_16';
SELECT ret_pago,* FROM proveedor WHERE nit = '9001157157'
...
SELECT  *
              ...
              SELECT * FROM nit WHERE cedula = '9001157157';
