select valor_anticipo, * from opav.sl_anticipos where cod_anticipo = 'ANP00085';--106404031
-- update opav.sl_anticipos set valor_anticipo = '47042121' where cod_anticipo = 'ANP00053'


select * from con.factura where documento = 'FPA00085';
