...
select * from fin.cxp_doc										select * from tem.lb01094_mcamila_DET WHERE DOCUMENTO = 'FZL00446'
...
CREATE TABLE TEM.MC13126_COMPDET AS				select * from TEM.LB01094_COMPDET	
...
select * from administrativo.historico_deducciones_fianza where  negocio = 'LB01094' and documento_relacionado = 'FZT05406'
...
select	
df.*
-- df.id,'', 'FINV', cp.proveedor, 'NC', cp.documento, 'NC CANCELACION CXP TEMPORALES FIANZA A '||'xxx'||' '||periodo_corte, cp.agencia,  '' , '', 'FAP', cp.documento, '0099-01-01 00:00:00', 
...
select * from  fin.cxp_doc where  proveedor ='1129537415' and dstrct='FINV' and tipo_documento='FAP' AND DOCUMENTO_RELACIONADO = 'FZL00448'  limit 10
UPDATE  fin.cxp_doc SET DOCUMENTO_RELACIONADO = 'FZL00446' where  proveedor ='1129537415' and dstrct='FINV' and tipo_documento='FAP' AND DOCUMENTO_RELACIONADO = 'FZL00448'  limit 10



select * from  fin.cxp_doc where documento in('FZL00446','FZL00448')
select * from  fin.cxp_items_doc where documento in('FZL00446')

select * from administrativo.historico_deducciones_fianza limit 10where id = 7362


'2018-06-01 12:12:58.369831'

select * from con.comprobante where numdoc like '%FZL%' limit 10