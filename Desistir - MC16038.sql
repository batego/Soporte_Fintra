...
VALUES ('', 'FINV',132988 , 'DES', 'BTERRAZA', NOW(),  'MC16038', 'Cliente desistio, segun lo informado por Henrry Ferrer');
...
CREATE TABLE tem.cpx_MC16038 AS				--SELECT * FROM tem.cpx_MC16038
select * from fin.cxp_doc
--delete from fin.cxp_doc
where documento_Relacionado = 'MC16038';

CREATE TABLE tem.cpx_items_MC16038 as
select * from fin.cxp_items_doc
--delete from fin.cxp_items_doc
where documento in ('MC16038')

CREATE TABLE tem.fact_MC16038 as
select * from con.factura 
--delete from con.factura
where negasoc in ('MC16038')

CREATE TABLE tem.fact_det_MC16038 as
select * from con.factura_detalle
-- delete from con.factura_detalle
where documento in (select documento from con.factura where negasoc in ('MC16038'))

CREATE TABLE tem.egre_MC16038 as
select * from egreso
--delete from egreso
where document_no in ('EG54902')

CREATE TABLE tem.egredet_MC16038 as
...
CREATE TABLE tem.comprob_MC16038 as
select * from con.comprobante
--delete from con.comprobante
where numdoc in ('MC16038')

CREATE TABLE tem.comprodet_MC16038 as
...
---DIFERIDOS (DIFERIDOS)
CREATE TABLE tem.fen_MC16038 as
select * from ing_fenalco
--delete from ing_fenalco
where codneg in ('MC16038')
